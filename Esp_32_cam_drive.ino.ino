...
const char* ssid     = "Blah";   //your network SSID
const char* password = "venu12345";   //your network password

String myScript = "/macros/s/AKfycbzpbktrpsc5bQmq6cipbKgg6h3GZYEWrg8uHCuFDYY906OUap5l94ng1evueyUMYs4z/exec";    //Create your Google Apps Script and replace the "myScript" path.
...
String myFoldername = "&myFoldername=TESTING1";
String myFilename = "&myFilename=TESTING1";
...
void loop()
{
  String currtime = ThingSpeak.readCreatedAt(1854980, "J4T6EJYGUDFS0U8T");
